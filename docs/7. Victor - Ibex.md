...
- ==Identificar momento en que primal (polytopeHull) funcione mucho mejor que el dual.==
- Verificar que sea un **problema del dual**. ==Calcular valor óptimo, comparar fon f(primal) y dual*A (con intervalos para comparar).==
- Si es un problema del dual, modificar soplex LEAVE por ENTER.
![image](https://i.imgur.com/d3yaD2Y.png)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzA4NTc3NTQyLDk2NzY3NzAzNSwtMjU4Mz
I3MjkwLC04NTA4MDQ2ODIsLTE0NDQ4MjMzMzcsLTYwNTQ0NjA4
MSwtMTI1OTI1MDcyNywtMTY5MjAzNjc2MywyMDExOTA4Mjc2LC
00NDg4OTMyMzcsNjE4MDQ0NTIsLTIwOTg5NTUxNzgsLTkwODg4
MzgxNiwxMzE2MDQ5NDg4LC03MTI0MTI2MjEsLTE2NDU5OTMyNT
ksLTExMzE2ODA4MDMsLTIwNzYwNjgwNDMsLTY1MTI2OTMyLC04
NjMyNjYzMTJdfQ==
-->