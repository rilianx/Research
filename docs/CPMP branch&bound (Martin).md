...
2. Se calculan los costos de colocar el grupo de items en los distintos stacks (cantidad de movimientos BG necesarios). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg4MDQxMjM5NywzNjEyOTM1NzgsLTExOD
