...
def contract(y, cy, Dbox):
    ...
    for i in range(dim):
        ...
        p0[i] = (cy(y) - cy[i]*y[i].lb) /cy[i]
        if p0[i]>=y[i].ub: continue
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTM4MjUxMDAsOTIwMTQ4NjQ0LC03NT
gyODA1MzcsLTExMDQ5NTIwNjEsODAxNzM4NDI2LC0xNDE5MTk4
NDA2LC0xNzQ2MTQzNDAzLDM2MjU0NjkxOSwtODM4NjcyNDMwLD
U0NTUwOTgzOSwxNTUwNjE5Njc3LC04MTgyMzY5NzYsLTE3NjI3
NTE5NDZdfQ==
-->