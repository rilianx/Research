...
Se puede reducir la caja en las distintas dimensiones:
Buscar mínimo valor $y_1^*$,​ tal que $y_1^* \leq f_1(x)$, $\underline{y_2} \leq f_2(x)$  .


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzMjcwNDg5Myw3OTE2Nzg3NDAsMTQ2OD
