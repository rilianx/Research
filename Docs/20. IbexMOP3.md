...
Pada cada arista (n-1) ptos
Generar plano agregando vértice min-max-max
Si plano domina al vértice opuesto, OK!
sino, obtener plano ortogonal y verificar.

Por ejemplo si tengo puntos: (min-max-max);(max-min-min); y'
creo vértice: (max-min-max) o (max-max-min)
Genero plano y verifico si y' es dominado, si no, genero el otro plano.

En más dimensiones...
(min-min-max-max);(max-X-X-min);(X-max-min-X)
al parecer se pueden crear los 4 planos (min-max-max-max)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1Mjk2MDQ5NTAsMTE0MDAzOTI3NiwtMz
E4MTE0NjQxLDk1MjQzODYyMCwxNjQ3Njg3NDgsMTc0MTcyOTgz
OSwxNDA3MTQ3NzYsLTU2NTc4MTI5OSwtMTc4OTQwNTg4NSwxMz
M0MDkxMDUwLC02NDAxMDQyMjgsMTczMzc5ODQzMiw3OTU2MTgw
MDYsLTQyMzM2NTE1NywxMjcyNzgzMzA2LDE0NzU5NzAxNjYsLT
EwNDYzNjE5NDMsLTIwNjcxNzM3MTMsMTU2NDM2MTY1NSwxNjYy
NTcxODAyXX0=
-->