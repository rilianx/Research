...
def contract(y, cy(ay+b), Dbox):    
    ...
    for i in range(dim):
        ...
        for j in range(dim):
            if i==j: continue
            grad[j]=-cy[j]
            t=max_t such that p-grad*t=Dbox[d], d=1..n
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjkwMzE0NjQsNzMwMzM3MTQxLDkyMD
E0ODY0NCwtNzU4MjgwNTM3LC0xMTA0OTUyMDYxLDgwMTczODQy
NiwtMTQxOTE5ODQwNiwtMTc0NjE0MzQwMywzNjI1NDY5MTksLT
gzODY3MjQzMCw1NDU1MDk4MzksMTU1MDYxOTY3NywtODE4MjM2
OTc2LC0xNzYyNzUxOTQ2XX0=
-->