...
Encontrar un mínimo valor $y_1^*$,​ tal que exista algún $x \in \bf{x}$, tal que $f(x) \leq y_1^*$ y $f_2(x) \leq \underline{y_2}$.



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTczMjkwNzQzMSw3OTE2Nzg3NDAsMTQ2OD
