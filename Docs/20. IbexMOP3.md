...
2. Generar puntos dominados hacia cada dirección de los puntos.

![generating hplanes](https://i.imgur.com/YdlaAMl.png)

3. **(The outtest direction)** Seleccionamos la dirección que maximiza la distancia con los segmentos y que apunta hacia afuera del polígono. En caso de no haber polígono (segmento dominado), se escoge una dirección hacia cada lado.
==Para saber cual se dirige fuera del polígono tenemos que comparar con tercer punto==
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTM5NTczMDEsLTMyNTY5NTk0MCw2NT
YyMzY0MzcsLTE4MTkxMTI2LC01NTEwNzAxMDYsLTIwNDExNDkz
NTksMTkxOTg0NDAyNywtMTQ4ODc3MTQ2MSwtMTUyOTYwNDk1MC
wxMTQwMDM5Mjc2LC0zMTgxMTQ2NDEsOTUyNDM4NjIwLDE2NDc2
ODc0OCwxNzQxNzI5ODM5LDE0MDcxNDc3NiwtNTY1NzgxMjk5LC
0xNzg5NDA1ODg1LDEzMzQwOTEwNTAsLTY0MDEwNDIyOCwxNzMz
Nzk4NDMyXX0=
-->