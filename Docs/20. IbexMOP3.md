...
En 3D, se pueden tomar 2 vértices $v_1$ y $v_2$ del polígono $P$ y escoger el punto $y^i$ correspondiente al vértice $v^i$ en la caja hull$(v_1,v_2)$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjUxNzY2MzI5LC0xNzg5NDA1ODg1LDEzMz
