...
En 3D, se pueden tomar 2 vértices $v_1$ y $v_2$ del polígono $P$ y escoger el punto $y^i$ que se corresponda al vértice $v^i$ de la caja $\mathbf{v}=hull(v_1,v_2)$.

Para ello se puede iterar por los componentes $k$ de $y^i$ e ir seleccionando los puntos $p$ con $p_k=y^i_k$. Luego de seleccionar un punto, todos los componentes equivalentes en $y^i$ se marcan ya que no deberían ser revisados.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2NTc4MTI5OSwtMTc4OTQwNTg4NSwxMz
...
NTcxODAyLDU3MDk5Mzk2NCwxNDA1ODg2MzE4LC04MjkwNzk3ND
MsLTE0Mjg2NjgzNTEsMzg2NTI3MzQ3LC04MDc1NDM3MTIsMjEy
MDg1Nzk5OF19
-->