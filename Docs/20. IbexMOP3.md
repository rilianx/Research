...
- `contract(box, c(y), hpbox)` Función que contracta la caja usando un hpbox específico. Condición necesaria par

````python
def reduce(y, c_y, dim=i, seg=D):
  # c_y[0]*y_1 +c_y[1]*y_2 +... = 0
  
  # hiper-segmentos convexos dominados
  # D[0][0]*y_1 + D[0][1]*y_2 +... = 0
  # ...
  # y_j = -c_y[0]*y_1 - c_y[1]*y_2 - ... c_y[i]*y_i
  
````
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA0NDkxOTkxLC0xMTA0OTUyMDYxLDgwMT
czODQyNiwtMTQxOTE5ODQwNiwtMTc0NjE0MzQwMywzNjI1NDY5
MTksLTgzODY3MjQzMCw1NDU1MDk4MzksMTU1MDYxOTY3NywtOD
E4MjM2OTc2LC0xNzYyNzUxOTQ2XX0=
-->