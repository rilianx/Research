...
def contract(y, cy(ay+b), Dbox):    
    ...
    for i in range(dim):
        ...
        for j in range(dim):
            ...
            grad[j]=0
````
![filtering_with_c4](https://i.imgur.com/XwVaE9w.png)


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU5OTE0OTcwLC0zNTg0NzkyNzMsNzMwMz
M3MTQxLDkyMDE0ODY0NCwtNzU4MjgwNTM3LC0xMTA0OTUyMDYx
LDgwMTczODQyNiwtMTQxOTE5ODQwNiwtMTc0NjE0MzQwMywzNj
I1NDY5MTksLTgzODY3MjQzMCw1NDU1MDk4MzksMTU1MDYxOTY3
NywtODE4MjM2OTc2LC0xNzYyNzUxOTQ2XX0=
-->