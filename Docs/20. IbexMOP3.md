...
Luego, agregamos las restricciones de que cada uno de estos puntos $p^j$ es no dominado y buscamos el mínimo $y_i
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3NDA5NDgxMCwtMjEwMDQzMzIxLDc5MT
