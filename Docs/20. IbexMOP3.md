...
¿Podemos contractar así $y_1$ de caja $\bf{y}$?
Minimizar $y_1^*$,​ tal que $y_1^* \leq f_1(x)$, $\underline{y_2} \leq f_2(x)$, sujeto a $gl(x)\leq 0$.


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA3ODc5NjMxMSw3OTE2Nzg3NDAsMTQ2OD
