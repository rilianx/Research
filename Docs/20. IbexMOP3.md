...
2. Proyectar hiper-segmentos a la cara perpendicular a $y_3$ (variable que queremos contractar).
3. Identificar hipersegmento que contiene el punto
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDY2NjkxMjkzLC0xNzYyNzUxOTQ2XX0=
-->