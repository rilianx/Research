...
1. Mirar polígono desde punta de vector ortonormal, e identificar puntos medios para cada segmento.
...
2. Generar puntos dominados sumando vector epsilon-unitario para obtener puntos en 3 direcciones. Y los proyectamos en el plano.

![generating hplanes](https://i.imgur.com/YdlaAMl.png)

3. Se filtran puntos que caen dentro del polígono ([link](https://inginious.org/course/competitive-programming/geometry-pointinconvex)).

4. **(The outtest direction)** Seleccionamos punto más lejano al segmento y creamos hiperplano usando el segmento y la dirección del punto.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyNTI1MTIyOCwxNzgyOTg5OTAsLTEwOT
M2MzEwODAsLTIwMDc2NzY5NzIsODM5OTI3MzgwLC0zMjU2OTU5
NDAsNjU2MjM2NDM3LC0xODE5MTEyNiwtNTUxMDcwMTA2LC0yMD
QxMTQ5MzU5LDE5MTk4NDQwMjcsLTE0ODg3NzE0NjEsLTE1Mjk2
MDQ5NTAsMTE0MDAzOTI3NiwtMzE4MTE0NjQxLDk1MjQzODYyMC
wxNjQ3Njg3NDgsMTc0MTcyOTgzOSwxNDA3MTQ3NzYsLTU2NTc4
MTI5OV19
-->