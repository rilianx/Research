...
1. Agregar plano inferior para contracción $c_y(y) > w$
2. Cálculo de distancia usando plano inferior
3. Agregar eps-constraint. Reducir $y$ al hacer peeler.
4. Almacenamiento de politopos $P_x$.
	- Sistema lineal: $g(x)\leq 0$ + caja $\mathbf{x}$.
5. Contracción usando politopos $P_x$:
	- $\min y_i$, s.t., $f_i(x)\leq y_i; f_j(x)\leq y_j(y_i)$
	- $y_j(y_i)$ se deduce de $c_y(y) = w$, con $y_k=\underline{y_k}$ para $k \neq i, j$

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5NjMzOTUxNywtMTMwNDMwNzkwNCwtOT
g4MTM2NDMwLC0zMDE2Mzk3MTksLTEyNjIwOTExMDIsMTI3MTkz
MTUzNSwtMTMwNDI3OTM2OSwtMjUyOTQyMzIxLC0xMzUxNzQxMD
Q3LDEzMzMyNTc2MTEsLTE4OTY3NTM3MjQsLTQxMTU1ODYwNSwt
MTUzMzE0NzMzNCwtMTgyNDAzODAxMCwxMjUzNDI4MzUxLDIxMj
E1MTI5MDIsODYxOTY1MDg5LDE0MjQ1MTE0NDEsMTQyMzI5NTY3
NCwtMTQwMzY5NzgyOV19
-->