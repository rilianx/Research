...
2. Agregar eps-constraint. Reducir y al hacer peeler.
3. Almacenamiento de politopos $P_x$.
	- Sistema lineal: $g(x)\leq 0$ + caja $\mathbf{x}$.
4. Contracción usando politopos $P_x$:
	- $\min y_i$, s.t., $f_i(x)\leq y_i; f_j(x)\leq y_j(y_i)$
	- $y_j(y_i)$ se deduce de 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2NTI3MDc1NiwtOTg4MTM2NDMwLC0zMD
E2Mzk3MTksLTEyNjIwOTExMDIsMTI3MTkzMTUzNSwtMTMwNDI3
OTM2OSwtMjUyOTQyMzIxLC0xMzUxNzQxMDQ3LDEzMzMyNTc2MT
EsLTE4OTY3NTM3MjQsLTQxMTU1ODYwNSwtMTUzMzE0NzMzNCwt
MTgyNDAzODAxMCwxMjUzNDI4MzUxLDIxMjE1MTI5MDIsODYxOT
Y1MDg5LDE0MjQ1MTE0NDEsMTQyMzI5NTY3NCwtMTQwMzY5Nzgy
OSwtMTIxNTY0ODA5OV19
-->