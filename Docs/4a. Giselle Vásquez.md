...
$r+\gamma V(s_{​+1})$ se conoce como TD (temporal difference) target y es una estimación del Q-value de la acción a en el estado s usando el valor del estado resultante. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5NDYzMDQxMiwxMDE3NDUyMzEsLTE0Mj
