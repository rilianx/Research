...
- Probar con otro ambiente: boulder-dash y si no bomber-man, y si no el ms. pacman
- Tratar de replicar el algoritmo del space-invaders
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxMDc5MjgxMCwtMTA0MDEyNDk0MywxMD
