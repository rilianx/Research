...
$P$ denotes a set of recommendations generated by primitive prediction models and $R$ denotes the recommendations generated by a recommender system to be evaluated.

$S = \frac{\sum{u(U)}}{|U|}$, i.e., the utility of the unexpected set divided by the total unexpected elements. Then, serendipity is defined as follows:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcyMjMxMDgzNSwyODY4Njk3MjAsLTE5ND
